...
async function inicializarBaseDeDatos() {
  try {
    ...
    // Asegurar columnas de entrega y fechas
    await pool.query(`
...
// Endpoint para actualizar tilde de impresión
...
// Endpoint para actualizar tilde de entrega por ítem
app.put('/api/ordenes/item/delivered/:id', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Error al actualizar ítem de entrega' });
  }
});

// Endpoint para actualizar datos de entrega (fecha prometida, entregado por, fecha entrega)
...
// Otras rutas base (Login, Catálogos, PDF) se mantienen intactas...
